...
public class BinarySearchTree<E extends Comparable<E>> extends BinaryTree<E>{
    ...
    /**
     * iterator function to if it used in the main
     * @return
     */
    ...
    public String toString(){
        ...
        builder.append("This is the level order traversing String:\n");
        iter.levelOrderTraverse(builder);
    ...
    private class MyIter<E> {
        ...
        /**
         * This function traverse the tree in level Order
         * @param sb
         */
        private void levelOrderTraverse(StringBuilder sb){
            E temp;
            while(hasNext()){
                temp = next();
    ...
    /**
     * This method written to reading file and generate
     * the tree with nodes
     * @param fileName
     * @throws IOException
     */
