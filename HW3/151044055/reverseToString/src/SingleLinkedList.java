 ...
 *This class provided from the source code of lecture book
 */
public class SingleLinkedList<E> {
    ...
    /**
     *WRITTEN FOR PART 2 OF HW3
     *
     * This function help us to get the reverse of the String recursively
     *@param str to get the reverse of it
     */
    public String reverseToString(String str){

        if(str == null || str.length() <= 1)
            return str;
        return "" + reverseToString(str.substring(1)) + str.charAt(0);
    }
